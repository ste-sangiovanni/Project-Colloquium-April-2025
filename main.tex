...
%Si magari metti anche lo stato di avanzamento degli altri paper (es. per parliamentary speeches, dì che stai iniziando a fare questo su questi dati e con questo metodo; per quello su campaign dataset, magari puoi accennare al data frame: periodo paesi; e ai risultati preliminari legati a ipotesi teoriche, 
%es. come ipotizziamo osserviamo che X ha effetto su Y ma solo se Z etc.). Se devi tagliare qualcosa nella presentazione taglia le cose più ovvie, un po' come ha detto Giovanna nel commento alle slide su Mannheim (es. non tutti al project colloquium conoscono la letteratura su valence, ma comunque non devi spenderci troppo tempo, cerca di consensare quelle cose in 1 slide). Chiaramente dipende da quanto tempo avrai a disposizione.

\begin{frame}
    % Introduction about my phd project
\end{frame}
...
\begin{frame}{Policy Shifts and Strategic Valence Emphasis in Electoral Competition}
    \begin{itemize}
        \item Research Question: How do parties adjust their emphasis on valence traits in response to changes in their policy positions?
        \item Theoretical Expectations: 
    \end{itemize}
\end{frame}
...
\begin{frame}{Research Design: Data and Methodology}
    \begin{itemize}
        \item Data: 
         \begin{itemize}
            \item Valence Data: Comparative Campaign Dynamics Dataset \customcite{debussomer-topcu2018comparative}
            \item Polls Data \customcite{Jennings2018}, Country-Specific Polls on Wikipedia
            \item Countries \& Election Years: Czech Republic (2010, 2013), Germany (2009, 2013), Spain (2008, 2011), Hungary (2010), Netherlands (2012), Poland (2007, 2011), Portugal (2009, 2011), Sweden (2010, 2014), UK (2005, 2010, 2015)
            \item 
        \end{itemize}
        \item Methodology:
    \end{itemize}
...
\textbf{Incumbency Status}          & \begin{tabular}[c]{@{}c@{}}Incumbent \\[2pt] Opposition\end{tabular}                                      \\   
