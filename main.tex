...
\begin{itemize}
    ...
    \item How parties navigate the trade-off between \textbf{positional} and \textbf{valence-based} strategies \customcites{stokes1992valence, clark2009valence} \vspace{0.2cm}
...
\begin{frame}{Structure of the Dissertation - 3 Interconnected Papers}
    \textbf{Paper 1: Electoral Campaigns and Valence}  
    \begin{itemize}
        \item Investigates how parties’ valence signaling during campaigns affects polling support
        \item Key focus: Character-based vs. policy-based valence and their impact on polls
    \end{itemize}
    \vspace{0.3cm}
    
    \textbf{Paper 2: Economic Performance and Strategic Valence}  
    \begin{itemize}
        \item Explores how governing and opposition parties adjust valence strategies in response to economic indicators
        \item Combines parliamentary debates with macroeconomic data
    \end{itemize}
    \vspace{0.3cm}
    
    \textbf{Paper 3: Political Scandals and Voter Evaluations}  
    \begin{itemize}
        \item Examines the effects of political scandals on voter perceptions using two experiments:
        \begin{itemize}
            \item Conjoint experiment
            \item Audio-based survey experiment
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Appendix 4 - Literature Gaps in Political Scandal Research}
    \begin{itemize}
