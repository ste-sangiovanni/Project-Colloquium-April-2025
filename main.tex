...
\begin{frame}{Conclusions and Next Steps}
    \textbf{Political Scandals and Voter Evaluations}
    \begin{itemize}
        \item Complete the pre-registration and get the ethical committee approval
        \item Validate the emotional tone of political speech (Calm vs. Aggressive) using SpeechBrain \customcite{speechbrain} trained on IEMOCAP
